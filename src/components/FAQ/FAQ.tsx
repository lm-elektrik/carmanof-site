...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Срок зависит от задачи и состояния панели. Перед запуском мы согласовываем детали, чтобы вы понимали этапы работы и результат.",
  },
  {
    question: "Работаете ли вы по всей России и как происходит отправка?",
    answer:
      "Да, работаем по всей России. Отправка и возврат обычно выполняются через СДЭК после согласования деталей и подтверждения работ.",
  },
];
...
export default function FAQ() {
  ...
  const handleToggle = (index: number) => {
    // Повторный клик по открытому пункту ничего не делает,
    // чтобы в блоке всегда оставался один открытый ответ.
